...
* `backgroundPhiColors.clipByVisibleRange`: clips the rendering only to the viewing area for large documents. Conversely, it is slower for small documents. Overview ruler lane is hidden.
